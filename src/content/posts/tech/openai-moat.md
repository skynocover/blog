...
因此要從OpenAI的模型轉換到其他模型**幾乎不存在轉換成本**
...
曾經OpenAI的壟斷性資源就是**閉源的GPT模型** (3.0及之後都是閉源)
...
整個七大市場力量看過一輪後 突然發現**OpenAI似乎真的沒有足夠穩固的護城河**
